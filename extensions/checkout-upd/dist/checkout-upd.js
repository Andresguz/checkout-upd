...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/checkout-upd/src/Checkout.jsx
  ...
  function render2(element, root, callback, reconciler = defaultReconciler) {
  ...
  function useRender() {
    const render4 = (0, import_react2.useContext)(RenderContext);
    if (render4 == null) {
  ...
  function reactExtension(target, render4) {
    return extension(target, (root, api) => __async(this, null, function* () {
      ...
      yield new Promise((resolve, reject) => {
        try {
          render2(/* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ExtensionApiContext.Provider, {
            value: api,
...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/extension-editor.mjs
  function useExtensionEditor() {
  ...
  render("Checkout::Dynamic::Render", () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(App, {}));
  function App() {
    const { message } = useSettings();
    const isInsideCheckoutEditor = useExtensionEditor();
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "Note", status: "info", children: "Hello MMMM  " });
  }
  function Extension() {
    const translate = useTranslate();
    const { extension: extension2 } = useApi();
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Banner2, { title: "checkout upd", children: [
      translate("gaaaa", { target: extension2.target }),
      "Hello world"
    ] });
  }
})();
